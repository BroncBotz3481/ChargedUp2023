...
/**
 * This is the Pipeline policy, holding all algorithmic functions for the psuedo
 * Pipeline Subsystem and Commands. Holds
...
public final class PipelinePolicy {
  ...
  /**
   * This double array holds yaw,pitch,area,and skew respectively in that order of
   * the Apriltag
   */
