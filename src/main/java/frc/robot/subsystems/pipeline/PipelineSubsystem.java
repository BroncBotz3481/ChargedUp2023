...
public class PipelineSubsystem extends SubsystemBase
{
  ...
  /**
   * Initializes the camera, best/alt photon position estimator, apriltag field layout
   */
  private PipelineSubsystem()
  {
    ...
    PipelinePolicy.bestPhotonPoseEstimator = new PhotonPoseEstimator(PipelinePolicy.aprilTagFieldLayout,
                                                                     ...
                                                                     PipelinePolicy.camera,
                                                                     PipelinePolicy.robotToCam);
   ...
   * sends the corners of the AprilTag all to the policy class updates location
   */
  @Override
