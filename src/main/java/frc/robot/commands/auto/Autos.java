...
public final class Autos {
    ...
    public static CommandBase basicBlueAuto1(SwerveSubsystem swerve, IntakeSubsystem intake) {
        List<PathPlannerTrajectory> example1 = PathPlanner.loadPathGroup("BasicBlueAuto1",
